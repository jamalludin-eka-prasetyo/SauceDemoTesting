...
for (int i = 1; i <= testdataLogin.getRowNumbers(); i++) {
    ...
    if (expectedResult == 'Failures') {
        WebUI.verifyElementPresent(findTestObject('Object Repository/Login_Page/h3_Alert_Username and passworddo not match'), 
            10, FailureHandling.STOP_ON_FAILURE)

        WebUI.verifyElementText(findTestObject('Object Repository/Login_Page/h3_Alert_Username and passworddo not match'), 
            'Epic sadface: Username and password do not match any user in this service', FailureHandling.STOP_ON_FAILURE)
        ...
        WebUI.verifyElementNotPresent(findTestObject('Object Repository/Login_Page/h3_Alert_Username and passworddo not match'), 
            10, FailureHandling.STOP_ON_FAILURE)
...
//        WebUI.click(findTestObject('Object Repository/Login_Page/a_Logout'))
        ...
        WebUI.callTestCase(findTestCase('Dashboard/Dashboard'), [('item_name') : '', ('item_description') : '', ('item_price') : 0], FailureHandling.STOP_ON_FAILURE)
